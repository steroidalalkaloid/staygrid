 ...
 */
class getRoomListingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RoomListingRepository' shared autowired service.
     *
     * @return \App\Repository\RoomListingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RoomListingRepository.php';

        return $container->privates['App\\Repository\\RoomListingRepository'] = new \App\Repository\RoomListingRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
