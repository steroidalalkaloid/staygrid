...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.LhxLCDA'] ?? self::get_ServiceLocator_LhxLCDAService($container)), ($container->privates['.service_locator.u8QZAbd'] ?? $container->load('get_ServiceLocator_U8QZAbdService')), ['admin' => [($container->privates['debug.security.authenticator.form_login.admin'] ?? $container->load('getDebug_Security_Authenticator_FormLogin_AdminService'))], 'main' => [($container->privates['debug.security.authenticator.form_login.main'] ?? $container->load('getDebug_Security_Authenticator_FormLogin_MainService'))]], false);
