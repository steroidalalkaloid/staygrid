 ...
 */
class getRoomsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RoomsRepository' shared autowired service.
     *
     * @return \App\Repository\RoomsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RoomsRepository.php';

        return $container->privates['App\\Repository\\RoomsRepository'] = new \App\Repository\RoomsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
