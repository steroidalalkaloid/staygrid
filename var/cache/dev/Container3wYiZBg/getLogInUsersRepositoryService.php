 ...
 */
class getLogInUsersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LogInUsersRepository' shared autowired service.
     *
     * @return \App\Repository\LogInUsersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LogInUsersRepository.php';

        return $container->privates['App\\Repository\\LogInUsersRepository'] = new \App\Repository\LogInUsersRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
